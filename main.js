...
const UICtrl = (function () {
  ...
  return {
    ...
    addIncomeItem: function (item) {
      ...
      incomeDescription.push(item.description);
      // display the chart 
      var xValues = incomeDescription;
      var yValues = incomeAmount;
    ...
    displayChart: function () {
        ...
        const description = document.querySelector(UISelectors.description)
    },
    ...
    updateSaving: function () {
      ...
      savingAvailable.innerHTML = ((+earned.innerHTML * +saving) / 100).toFixed(
        2
      );
    },
...
const App = (function () {
  ...
  const loadEventListeners = function () {
    ...
    //add new saving
    document
      .querySelector(UISelectors.savingBtn)
      .addEventListener("click", addSaving);
    //delete item
    document
